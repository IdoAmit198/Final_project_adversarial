...
srun -c 16 --gres=gpu:1 python3 run.py --model_name resnet50 \
    --dataset imagenet --AutoAttackInference \
    --eval_model_path saved_models/imagenet/fine_tune_clean/resnet50/seed_42/train_method_adaptive/agnostic_loss_False/GradAlign_True/optimizer_SGD/pgd_steps_2/schdeuler_CosineAnnealingWarmRestarts/lr_0.001/epochs_160/max_epsilon_16.pth