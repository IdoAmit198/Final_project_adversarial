...
srun -c 16 --gres=gpu:1 python3 run.py  --model_name preact_resnet18 \
            --Inference \
            --eval_model_path saved_models/imagenet100/preact_resnet18/seed_42/train_method_adaptive/agnostic_loss_False/optimizer_SGD/pgd_steps_1/max_epsilon_32.pth
